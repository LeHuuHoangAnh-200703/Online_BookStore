...
const submitForm = async () => {
    ...
    try {
        ...
        const response = await axios.post('http://localhost:5000/api/theodoimuonsach', dataSend);

        notification.value = {
            message: 'Thông tin mượn sách đã được thêm thành công!',
            type: 'success'
        };
    } catch (error) {
        notification.value = {
        ...
        <div class="flex flex-col w-full">
            ...
            <div class="relative w-[95%] mx-auto h-[100%] my-5 overflow-hidden">
                <div class="text-center py-4">
                    <h2 class="text-[#333] font-bold text-[20px]">THÊM THÔNG TIN MƯỢN SÁCH</h2>
                </div>
                    ...
                    <div
                        ...
                        <div class="">
                            <div>
                                ...
                                <input v-model="formData.NgayMuon" name="MaSach" autofocus type="date" id="NgayMuon"
