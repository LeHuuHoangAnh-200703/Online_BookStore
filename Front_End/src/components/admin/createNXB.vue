...
const generateMaNXB = () => {
    return 'NXB' + Math.floor(10000 + Math.random() * 90000);
};
const formData = ref({
    idNXB: generateMaNXB(),
    TenNXB: '',
...
const submitForm = async () => {
    ...
    try {
        ...
        const response = await axios.post('http://localhost:5000/api/nhaxuatban', dataSend);
    ...
    <div class="flex font-sans">
        ...
        <div class="flex flex-col w-full">
            ...
            <div class="relative w-[95%] mx-auto h-[100%] my-5 overflow-hidden">
                ...
                <form @submit.prevent="submitForm" action="/admin/addproduct" method="POST" enctype="multipart/form-data" id="all_products"
